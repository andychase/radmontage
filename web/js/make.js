...
var ajax_channel_and_title, allowed_in_time_field, allowed_in_title_field, api_key, append_new_video_container, append_new_video_container_if_none_left, clear_video_image, clear_video_title, do_action_button_with_save, finishedSerializing, get_link_from_montage_container, get_montage_title, get_url_parameter, link_to_img, make_link_container, montage_id, montage_link_container, montage_link_entered, montage_links, montage_secret, my_host_url, new_endpoint, save_endpoint, serialize, serializeAndSave, set_video_image, set_video_title, text_to_time, time_to_text, unserialize, update_previous_montages, video_title_markup, watch_link, youtube_api_endpoint, youtube_channel_link, youtube_video_link;
...
update_previous_montages = function(link_data) {
