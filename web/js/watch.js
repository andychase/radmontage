...
var get_endpoint, get_param_and_start, get_video_end, get_video_start, get_video_url, iOS, if_zero_return_null, onPlayerReady, onPlayerStateChange, onYouTubeIframeAPIReady, player, ready, testCardImageBasePath;
...
$(function() {
  var bgvid, clearOverlay, overlay, overlay_i, overlays, playing, showStaticOverlay, video_index;
  overlay = $('#overlay');
  bgvid = $('#bgvid');
  overlay_i = 0;
  video_index = 0;
